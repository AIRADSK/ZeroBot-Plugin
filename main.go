...
import (
	...
	_ "github.com/AIRADSK/ZeroBot-Plugin/plugin/givemoney"          //
	...
	_ "github.com/FloatTech/ZeroBot-Plugin-Playground/plugin/partygame" // 派对游戏轮盘赌
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "枫叶", "Set default nickname.")
